...
void setPWMMotors2(int pin_real1, int pin_real2) {

    int powerpin1 = rotate_motor[pin_real1 - 8];
    int power = (powerpin1 != 0)?powerpin1 : rotate_motor[pin_real2 - 8];

    int pin1 = (powerpin1 != 0)?pin_real1 : pin_real2;
    int pin2 = (pin_real1 + pin_real2) - pin1;

    if (power < 0 || power > 4096) return;
    int power_current1 = Motor_speed[pin1 - 8];
    int power_current2 = Motor_speed[pin_real2];
    ...
    // Serial.print(power);
    // Serial.print(" pin: ");
    // Serial.print(pin_real1);
    // Serial.print(" ");
    // Serial.println(pin_real2);
    pwms[pin1] = power;
    pwms[pin2] = 0;
